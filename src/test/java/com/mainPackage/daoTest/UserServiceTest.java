...
public class UserServiceTest
{
	...
	public void addDummyAccounts()
	{
		...
		if(admin == null)
		{
			admin = new User("admin", Passwords.hashPassword("admin"), "firstNameAdmin", "lastNameAdmin", "admin@mail.org", true, new Date(), listAdminAuths);
		...
		if(user == null)
		{
			user = new User("user", Passwords.hashPassword("user"), "firstNameUser", "lastNameUser", "user@mail.org", true, new Date(), listUserAuth);
		...
		if(disabled == null)
		{
			disabled = new User("disabled", Passwords.hashPassword("disabled"), "firstNamedisabled", "lastNamedisabled", "disabled@mail.org", false, new Date(), listAdminAuths);
